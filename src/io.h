...
#define FLASHING 2
enum LEDs {
		BALL_1=0, BALL_2, BALL_3, BALL_4, BALL_5,LEFT_CAPTURE_LIGHT,RIGHT_CAPTURE_LIGHT,TOP_CAPTURE_LIGHT,RED_TARGET_LEFT,RED_TARGET_RIGHT,RED_TARGET_TOP,RED_TARGET_BOTTOM
};
